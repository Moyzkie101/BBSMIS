...
INSERT INTO `tblbrgy_info` (`id`, `province`, `town`, `brgy_name`, `number`, `text`, `image`, `city_logo`, `brgy_logo`, `map_url`) VALUES
(1, 'Samar1', 'POBLACION KALIBO', 'BRGY KALIBO AKLAN', '0919-1234567', 'Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Sed porttitor lectus nibh. Curabitur aliquet quam id dui posuere blandit.', '09052021075440182970012_615550183178722_2776607156578360582_n.jpg', '03052021033434brgy-logo.png', '0905202107542630042021035316lgu-logo.png', '<iframe src=\"https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15711.068339152867!2d123.51937427737289!3d10.118141734322691!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a96202aa5853f9%3A0x91149820c4490574!2sBolocboloc%2C%20Barili%2C%20Cebu!5e0!3m2!1sen!2sph!4v1658560978395!5m2!1sen!2sph\" width=\"800\" height=\"600\" style=\"border:0;\" allowfullscreen=\"\" loading=\"lazy\" referrerpolicy=\"no-referrer-when-downgrade\"></iframe>');
...
--
-- Table structure for table `tbldocument_request`
--

CREATE TABLE `tbldocument_request` (
  `id` int(11) NOT NULL,
  `resident_id` int(11) NOT NULL,
  `request_date` date NOT NULL,
  `request_service` varchar(200) NOT NULL,
  `request_purpose` text NOT NULL,
  `request_payment_method` varchar(50) NOT NULL,
  `request_ref_no` int(11) NOT NULL,
  `request_status` varchar(25) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbldocument_request`
--

INSERT INTO `tbldocument_request` (`id`, `resident_id`, `request_date`, `request_service`, `request_purpose`, `request_payment_method`, `request_ref_no`, `request_status`) VALUES
(1, 171, '2022-07-23', 'Barangay Clearance', 'For Employment Purpose Only', 'GCash', 12345, 'Pending');
...
(11, 'Barangay Clearance Payment', '10.00', '2022-07-18', 'admin', ' Ronil 213213 Cajan');
...
INSERT INTO `tblresident` (`id`, `national_id`, `citizenship`, `picture`, `firstname`, `middlename`, `lastname`, `alias`, `birthplace`, `birthdate`, `age`, `civilstatus`, `gender`, `purok`, `voterstatus`, `identified_as`, `phone`, `email`, `occupation`, `address`, `resident_type`, `remarks`, `status`) VALUES
(171, '321321321', 'Filipino', '18052021113447Screenshot2021-05-06183815.png', 'Ronil', 'Poe', 'Cajan', 'FPJ', 'Metro  Manila', '2021-04-05', 1, 'Single', 'Male', 'Purok 2', 'Yes', 'Unidentified', '19512659595', 'cajanr02rtrt22@gmail.com', 'IT', '310 W Las Colinas Blvd', 1, 'dasds', 'Approved'),
...
(180, '1212321321', 'American', '18052021113745sl9JaS.jpg', 'Ronil', '213213', 'Cajan', '', '321321', '2021-04-28', 33, 'Widow', 'Male', 'Purok 3', 'No', '', '19512659595', 'cajanr0222@gmail.com', 'IT', '310 W Las Colinas Blvd', 0, 're', 'Pending');
...
--
-- Indexes for table `tbldocument_request`
--
ALTER TABLE `tbldocument_request`
  ADD PRIMARY KEY (`id`);
